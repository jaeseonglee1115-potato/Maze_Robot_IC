module MazeRunner(
  ...
  ///////////////////////////////////
  inert_intf #(FAST_SIM) iINTF(.clk(clk),.rst_n(rst_n),.strt_cal(strt_cal),
  ...
  // removed ths , dont neeed it , might need it later .clk(clk)
  ...
  logic signed [11:0] lft_spd_p, rght_spd_p;
  ...
  /////////////////////////////////  
  MtrDrv iMTR(.clk(clk),.rst_n(rst_n),.lft_spd(lft_spd_p),.rght_spd(rght_spd_p),
